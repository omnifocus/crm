...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lei")
                .setOutputDir("/Users/love/Documents/owndata/new_starter/ssm/crm/src/main/java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/crm?serverTimezone=UTC")
                .setUsername("root").setPassword("411323root");
        ...
        packageConfig.setParent("com.shilei").setMapper("mapper")
